...
Este repositório de casos foi construído tendo como base os trabalhos [Casos em Administração](https://blog.casoteca.app.br/) de (COSTA, 2023) e [A Case-Based Approach for introducing Testing Tools and Principles ](https://hal.science/hal-03221897/document) de (DADEAU, GROS e PEUREUX, 2020) que orientam sobre a construção de casos que podem ser utilizados no contexto da estratégia ativa Aprendizagem Baseada em Casos. Os casos disponíveis aqui neste repositório podem ser aplicados para apoiar o ensino em disciplinas de Engenharia de Software.  Ou também podem ser utilizados por qualquer pessoa interessada, independentemente do seu nível de experiência. À medida que você avança, encontrará não apenas teoria, mas também orientações práticas e exemplos baseados em situações reais e que o ajudarão a aprimorar suas habilidades em teste de software.
...
### 1. Técnicas de Teste Contempladas neste Trabalho <a name="tecnicateste"></a>
